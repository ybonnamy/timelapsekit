...
cp /var/motion/timelapse/IntegratedWebcam.tmp.avi /var/motion/timelapse/IntegratedWebcam.avi
cp /var/motion/timelapse/pwc.tmp.avi /var/motion/timelapse/pwc.avi
cp /var/motion/timelapse/EndoscopeUSB.tmp.avi /var/motion/timelapse/EndoscopeUSB.avi
