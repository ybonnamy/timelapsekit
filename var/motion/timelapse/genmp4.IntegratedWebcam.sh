...
mencoder mf:////var/motion/snapshots/*IntegratedWebcam.jpg -mf w=1600:h=1200:fps=25:type=jpg -ovc x264 -o /var/motion/timelapse/IntegratedWebcam.tmp.mp4 -of lavf
